...
typedef struct vnode_ops {
        ...
        /*
         * Everything within 'vma' other than vma->vma_obj (and
         * vma_plink--meaning that 'vma' has not yet been entered into
         * a list of vmareas) will have been initialized before this
        ...
        /*
         * Used by vnode mm_objects (and by no one else):
         * Specifically, the vnode mm_object functions are
         * vreadpage(), vdirtypage() and vcleanpage() in vnode.c.
         */
        /*
